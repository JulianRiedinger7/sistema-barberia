    ...
    return (
        <main className="container mx-auto px-4 py-8 max-w-5xl">
            <header className="mb-12 text-center relative">
                ...
                <h1 className="text-4xl font-bold mb-2 tracking-tight text-primary">Reserva tu Cita</h1>
                <p className="text-muted-foreground">Sigue los pasos para agendar tu turno.</p>
            </header>
